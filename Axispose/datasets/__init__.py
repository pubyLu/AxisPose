...
def get_dataset(args, config):
    ...
    elif config.data.dataset =='Projection':
        img_size = 128
        dataset = Projection(args.datasetPath,img_size,img_size,transforms=tran_transform,)
        test_dataset = Projection(args.testDatasetPath, img_size,img_size,transforms = test_transform)
